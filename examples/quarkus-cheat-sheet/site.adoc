...
[%collapsible]
====
include::network.adoc[tag=update_14_16]
====
...
[%collapsible]
====
include::persistence.adoc[tag=update_14_18]
====
...
.Panache and Optional
[%collapsible]
====
include::persistence.adoc[tag=update_12_1]
====

.Quartz
[%collapsible]
====
include::misc.adoc[tag=update_12_2]
====

.Automatic Readiness Probes
[%collapsible]
====
include::network.adoc[tag=update_12_3]
====

.Kubernetes Deployment Targets
[%collapsible]
====
include::cloud.adoc[tag=update_12_4]
====

.Quartz Expression Type
[%collapsible]
====
include::misc.adoc[tag=update_12_5]
====

.Lock and Hint
[%collapsible]
====
include::persistence.adoc[tag=update_12_6]
====

.Flyway Multiple Datasource support
[%collapsible]
====
include::persistence.adoc[tag=update_12_7]
====

.Qute Template engine
[%collapsible]
====
include::misc.adoc[tag=update_12_8]
====

.JSON Logging Format
[%collapsible]
====
include::core.adoc[tag=update_12_9]
====

.Sentry Logging
[%collapsible]
====
include::misc.adoc[tag=update_12_10]
====

.Spring Security
[%collapsible]
====
include::spring.adoc[tag=update_12_11]
====

.YAML Config
[%collapsible]
====
include::core.adoc[tag=update_12_12]
====
...
[%collapsible]
====
include::security.adoc[tag=update_11_1]
====

.Alter RBAC behaviour
[%collapsible]
====
include::security.adoc[tag=update_11_2]
====

.Tuning generated Kubernetes resouces
[%collapsible]
====
include::cloud.adoc[tag=update_11_3]
====

.HTTPS Rest Client
[%collapsible]
====
include::core.adoc[tag=update_11_4]
====

.Timeout Rest Client
[%collapsible]
====
include::core.adoc[tag=update_11_5]
====

.Select Container Runtime
[%collapsible]
====
include::cloud.adoc[tag=update_11_6]
====

.Spring Web supported types
[%collapsible]
====
include::spring.adoc[tag=update_11_7]
====

.AWS Lambda Archetype
[%collapsible]
====
include::cloud.adoc[tag=update_11_8]
====
