...
An endpoint is registered automatically at `/q/metrics` providing default metrics.
...
// tag::update_24_6[]
Quarkus integrates with the OpenTelemetry project.
For exporting traces to a Jaeger collector, use the `quarkus-opentelemetry-exporter-jaeger` extension.
// end::update_24_6[]
