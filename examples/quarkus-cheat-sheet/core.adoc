...
*Produces*
// tag::update_5_4[]
You can also create factory of object by using `@javax.enterprise.inject.Produces` annotation.
...
You can use qualifiers to return different implementations of same interface or to customize configuration of bean.
