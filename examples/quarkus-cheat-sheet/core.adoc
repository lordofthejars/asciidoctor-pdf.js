...
If you don't want to use the default `ObjectMapper` you can customize by:
...
I recommend reading this document xxxxxyyyyyzzzz to understand how JaCoCo and Quarkus works and how you can configure JaCoCo to get correct data.
// end::update_6_3[]
